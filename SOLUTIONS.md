# The [LeetCode](https://leetcode.com) Solutions
...
The only special case is if the leading digit is a 9 that needs to get added to, in which case it is 1 with a bunch of 0s behind it.
